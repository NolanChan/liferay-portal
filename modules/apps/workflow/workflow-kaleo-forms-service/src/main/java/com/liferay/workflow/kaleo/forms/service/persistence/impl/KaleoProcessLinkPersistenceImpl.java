...
import com.liferay.workflow.kaleo.forms.model.impl.KaleoProcessLinkModelImpl;
 ...
 * @see com.liferay.workflow.kaleo.forms.service.persistence.KaleoProcessLinkUtil
 * @generated
 */
@ProviderType
public class KaleoProcessLinkPersistenceImpl extends BasePersistenceImpl<KaleoProcessLink>
	...
	protected void cacheUniqueFindersCache(
		KaleoProcessLinkModelImpl kaleoProcessLinkModelImpl, boolean isNew) {
		if (isNew) {
	...
	public KaleoProcessLink updateImpl(KaleoProcessLink kaleoProcessLink) {
		...
		clearUniqueFindersCache(kaleoProcessLinkModelImpl);
		cacheUniqueFindersCache(kaleoProcessLinkModelImpl, isNew);
	...
	/**
	 * Returns the kaleo process link with the primary key or throws a {@link com.liferay.portal.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the kaleo process link
