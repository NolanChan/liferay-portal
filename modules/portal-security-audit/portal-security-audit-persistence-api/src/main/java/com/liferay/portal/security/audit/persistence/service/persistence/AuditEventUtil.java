...
package com.liferay.portal.security.audit.persistence.service.persistence;
...
public class AuditEventUtil {
	...
	*/
	public static List<AuditEvent> findByCompanyId(long companyId, int start,
		int end) {
	...
	*/
	public static AuditEvent findByCompanyId_First(long companyId,
		OrderByComparator<AuditEvent> orderByComparator)
		throws com.liferay.portal.security.audit.persistence.exception.NoSuchEventException {
		return getPersistence()
	...
	*/
	public static AuditEvent fetchByCompanyId_First(long companyId,
		OrderByComparator<AuditEvent> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchEventException if a matching audit event could not be found
	*/
	public static AuditEvent findByCompanyId_Last(long companyId,
		OrderByComparator<AuditEvent> orderByComparator)
		throws com.liferay.portal.security.audit.persistence.exception.NoSuchEventException {
		return getPersistence()
	...
	*/
	public static AuditEvent fetchByCompanyId_Last(long companyId,
		OrderByComparator<AuditEvent> orderByComparator) {
		return getPersistence()
	...
	*/
	public static AuditEvent[] findByCompanyId_PrevAndNext(long auditEventId,
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, AuditEvent> fetchByPrimaryKeys(
