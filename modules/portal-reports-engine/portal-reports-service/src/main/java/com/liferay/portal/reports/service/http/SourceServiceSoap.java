...
package com.liferay.portal.reports.service.http;
 ...
 * is translated to an array of {@link com.liferay.portal.reports.model.SourceSoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.portal.reports.model.Source}, that is translated to a
 * {@link com.liferay.portal.reports.model.SourceSoap}. Methods that SOAP cannot
 ...
 * @see com.liferay.portal.reports.model.SourceSoap
...
public class SourceServiceSoap {
	public static com.liferay.portal.reports.model.SourceSoap addSource(long groupId,
		...
		try {
			...
			com.liferay.portal.reports.model.Source returnValue = SourceServiceUtil.addSource(groupId,
					nameMap, driverClassName, driverUrl, driverUserName,
					driverPassword, serviceContext);

			return com.liferay.portal.reports.model.SourceSoap.toSoapModel(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.liferay.portal.reports.model.SourceSoap deleteSource(
		long sourceId) throws RemoteException {
		try {
			com.liferay.portal.reports.model.Source returnValue = SourceServiceUtil.deleteSource(sourceId);
	...
	public static com.liferay.portal.reports.model.SourceSoap[] getSources(
		long groupId, java.lang.String name, java.lang.String driverUrl,
		boolean andSearch, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws RemoteException {
		try {
			java.util.List<com.liferay.portal.reports.model.Source> returnValue = SourceServiceUtil.getSources(groupId,
					name, driverUrl, andSearch, start, end, orderByComparator);

			return com.liferay.portal.reports.model.SourceSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.liferay.portal.reports.model.SourceSoap updateSource(
		...
		try {
			...
			com.liferay.portal.reports.model.Source returnValue = SourceServiceUtil.updateSource(sourceId,
					nameMap, driverClassName, driverUrl, driverUserName,
					driverPassword, serviceContext);
