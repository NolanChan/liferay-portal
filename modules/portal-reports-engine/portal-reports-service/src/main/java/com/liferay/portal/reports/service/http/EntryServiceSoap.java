 ...
 * is translated to an array of {@link com.liferay.portal.reports.model.EntrySoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.portal.reports.model.Entry}, that is translated to a
 * {@link com.liferay.portal.reports.model.EntrySoap}. Methods that SOAP cannot
 ...
 * @see com.liferay.portal.reports.model.EntrySoap
...
public class EntryServiceSoap {
	public static com.liferay.portal.reports.model.EntrySoap addEntry(long groupId,
		...
		try {
			com.liferay.portal.reports.model.Entry returnValue = EntryServiceUtil.addEntry(groupId,
			...
			return com.liferay.portal.reports.model.EntrySoap.toSoapModel(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.liferay.portal.reports.model.EntrySoap[] getEntries(
		...
		throws RemoteException {
		try {
			java.util.List<com.liferay.portal.reports.model.Entry> returnValue = EntryServiceUtil.getEntries(groupId,
					definitionName, userName, createDateGT, createDateLT,
					andSearch, start, end, orderByComparator);

			return com.liferay.portal.reports.model.EntrySoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
