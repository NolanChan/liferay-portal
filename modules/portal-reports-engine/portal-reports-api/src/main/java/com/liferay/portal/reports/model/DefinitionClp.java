...
import com.liferay.portal.reports.service.ClpSerializer;
...
public class DefinitionClp extends BaseModelImpl<Definition>
	...
	public void setLastPublishDate(Date lastPublishDate) {
		...
		if (_definitionRemoteModel != null) {
			try {
				...
				method.invoke(_definitionRemoteModel, lastPublishDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.portal.reports.model.Definition");
	...
	private Class<?> _clpSerializerClass = com.liferay.portal.reports.service.ClpSerializer.class;
