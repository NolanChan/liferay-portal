 ...
 * is translated to an array of {@link com.liferay.reports.model.EntrySoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.reports.model.Entry}, that is translated to a
 * {@link com.liferay.reports.model.EntrySoap}. Methods that SOAP cannot
 ...
 * @see com.liferay.reports.model.EntrySoap
...
public class EntryServiceSoap {
	...
	public static com.liferay.reports.model.EntrySoap deleteEntry(long entryId)
		throws RemoteException {
		try {
			com.liferay.reports.model.Entry returnValue = EntryServiceUtil.deleteEntry(entryId);
	...
	public static com.liferay.reports.model.EntrySoap[] getEntries(
		...
		throws RemoteException {
		try {
			java.util.List<com.liferay.reports.model.Entry> returnValue = EntryServiceUtil.getEntries(groupId,
					definitionName, userName, createDateGT, createDateLT,
					andSearch, start, end, orderByComparator);

			return com.liferay.reports.model.EntrySoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
