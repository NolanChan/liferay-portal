...
String notificationEmailSubject = PrefsParamUtil.getString(portletPreferences, request, "notificationEmailSubject", ContentUtil.get(PortletPropsValues.SPI_NOTIFICATION_EMAIL_SUBJECT));
