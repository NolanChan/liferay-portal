 ...
 */
public class LCSStatsPortletMetricsSummaryEventsPersistenceImpl
	extends BaseLCSStatsPersistenceImpl<LCSStatsPortletMetricsEvents>
	implements LCSStatsPortletMetricsSummaryEventsPersistence {
	...
	@Override
	public List<LCSStatsPortletMetricsEvents> fetchByC_E_G_K(
