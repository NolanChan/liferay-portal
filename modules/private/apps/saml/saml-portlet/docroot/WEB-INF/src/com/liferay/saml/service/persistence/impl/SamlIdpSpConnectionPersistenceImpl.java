 ...
 * @see com.liferay.saml.service.persistence.SamlIdpSpConnectionUtil
 * @generated
 */
@ProviderType
public class SamlIdpSpConnectionPersistenceImpl extends BasePersistenceImpl<SamlIdpSpConnection>
	...
	protected void cacheUniqueFindersCache(
		SamlIdpSpConnectionModelImpl samlIdpSpConnectionModelImpl, boolean isNew) {
		if (isNew) {
	...
	public SamlIdpSpConnection updateImpl(
		...
		clearUniqueFindersCache(samlIdpSpConnectionModelImpl);
		cacheUniqueFindersCache(samlIdpSpConnectionModelImpl, isNew);
