...
import com.liferay.saml.exception.NoSuchIdpSsoSessionException;
 ...
 * @see com.liferay.saml.service.persistence.SamlIdpSsoSessionUtil
 * @generated
 */
@ProviderType
public class SamlIdpSsoSessionPersistenceImpl extends BasePersistenceImpl<SamlIdpSsoSession>
	...
	protected void cacheUniqueFindersCache(
		SamlIdpSsoSessionModelImpl samlIdpSsoSessionModelImpl, boolean isNew) {
		if (isNew) {
			Object[] args = new Object[] {
					samlIdpSsoSessionModelImpl.getSamlIdpSsoSessionKey()
				};

			finderCache.putResult(FINDER_PATH_COUNT_BY_SAMLIDPSSOSESSIONKEY,
				args, Long.valueOf(1));
			finderCache.putResult(FINDER_PATH_FETCH_BY_SAMLIDPSSOSESSIONKEY,
				args, samlIdpSsoSessionModelImpl);
		}
		else {
	...
	protected void clearUniqueFindersCache(
		...
		finderCache.removeResult(FINDER_PATH_COUNT_BY_SAMLIDPSSOSESSIONKEY, args);
		finderCache.removeResult(FINDER_PATH_FETCH_BY_SAMLIDPSSOSESSIONKEY, args);
	...
	public SamlIdpSsoSession updateImpl(SamlIdpSsoSession samlIdpSsoSession) {
		...
		clearUniqueFindersCache(samlIdpSsoSessionModelImpl);
		cacheUniqueFindersCache(samlIdpSsoSessionModelImpl, isNew);
	...
	public SamlIdpSsoSession fetchByPrimaryKey(Serializable primaryKey) {
		SamlIdpSsoSession samlIdpSsoSession = (SamlIdpSsoSession)entityCache.getResult(SamlIdpSsoSessionModelImpl.ENTITY_CACHE_ENABLED,
	...
	private static final SamlIdpSsoSession _nullSamlIdpSsoSession = new SamlIdpSsoSessionImpl() {
			@Override
			public Object clone() {
				return this;
			}
	...
	private static final CacheModel<SamlIdpSsoSession> _nullSamlIdpSsoSessionCacheModel =
