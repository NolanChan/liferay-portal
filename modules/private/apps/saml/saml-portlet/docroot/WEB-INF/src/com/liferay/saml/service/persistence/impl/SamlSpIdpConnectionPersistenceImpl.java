 ...
 * @see com.liferay.saml.service.persistence.SamlSpIdpConnectionUtil
 * @generated
 */
@ProviderType
public class SamlSpIdpConnectionPersistenceImpl extends BasePersistenceImpl<SamlSpIdpConnection>
	...
	protected void cacheUniqueFindersCache(
		SamlSpIdpConnectionModelImpl samlSpIdpConnectionModelImpl, boolean isNew) {
		if (isNew) {
	...
	public SamlSpIdpConnection updateImpl(
		...
		clearUniqueFindersCache(samlSpIdpConnectionModelImpl);
		cacheUniqueFindersCache(samlSpIdpConnectionModelImpl, isNew);
	...
	public SamlSpIdpConnection fetchByPrimaryKey(Serializable primaryKey) {
		SamlSpIdpConnection samlSpIdpConnection = (SamlSpIdpConnection)entityCache.getResult(SamlSpIdpConnectionModelImpl.ENTITY_CACHE_ENABLED,
