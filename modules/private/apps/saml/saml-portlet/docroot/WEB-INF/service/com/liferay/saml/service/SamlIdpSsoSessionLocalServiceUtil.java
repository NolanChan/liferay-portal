 ...
 * {@link com.liferay.saml.service.impl.SamlIdpSsoSessionLocalServiceImpl} and is the
...
public class SamlIdpSsoSessionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.saml.service.impl.SamlIdpSsoSessionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static SamlIdpSsoSessionLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SamlIdpSsoSessionLocalService.class.getName());

			if (invokableLocalService instanceof SamlIdpSsoSessionLocalService) {
				_service = (SamlIdpSsoSessionLocalService)invokableLocalService;
			}
			else {
				_service = new SamlIdpSsoSessionLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(SamlIdpSsoSessionLocalServiceUtil.class,
				"_service");
		}
	...
	private static SamlIdpSsoSessionLocalService _service;
}