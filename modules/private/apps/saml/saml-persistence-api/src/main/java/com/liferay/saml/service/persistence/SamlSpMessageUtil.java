 ...
 * @see com.liferay.saml.service.persistence.impl.SamlSpMessagePersistenceImpl
 * @generated
 */
@ProviderType
public class SamlSpMessageUtil {
	...
	*/
	public static List<SamlSpMessage> findByExpirationDate(Date expirationDate) {
	...
	*/
	public static SamlSpMessage findByExpirationDate_First(
		Date expirationDate, OrderByComparator<SamlSpMessage> orderByComparator)
		throws com.liferay.saml.exception.NoSuchSpMessageException {
		return getPersistence()
	...
	* @throws NoSuchSpMessageException if a matching saml sp message could not be found
	*/
	public static SamlSpMessage findByExpirationDate_Last(Date expirationDate,
		OrderByComparator<SamlSpMessage> orderByComparator)
		throws com.liferay.saml.exception.NoSuchSpMessageException {
		return getPersistence()
	...
	*/
	public static SamlSpMessage[] findByExpirationDate_PrevAndNext(
		...
		throws com.liferay.saml.exception.NoSuchSpMessageException {
		return getPersistence()
				   .findByExpirationDate_PrevAndNext(samlSpMessageId,
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, SamlSpMessage> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<SamlSpMessagePersistence, SamlSpMessagePersistence> _serviceTracker =
		ServiceTrackerFactory.open(SamlSpMessagePersistence.class);
}