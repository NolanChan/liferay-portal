...
public class PortletPropsValues {
	...
	public static final long SAML_IDP_SSO_SESSION_MAX_AGE =
		GetterUtil.getInteger(
			PortletProps.get(PortletPropsKeys.SAML_IDP_SSO_SESSION_MAX_AGE),
			86400000);
	...
	public static final long SAML_SP_AUTH_REQUEST_MAX_AGE =
		GetterUtil.getInteger(
			PortletProps.get(PortletPropsKeys.SAML_SP_AUTH_REQUEST_MAX_AGE),
			86400000);
