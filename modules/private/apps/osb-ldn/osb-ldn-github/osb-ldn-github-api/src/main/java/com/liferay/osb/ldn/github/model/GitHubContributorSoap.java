...
public class GitHubContributorSoap implements Serializable {
	...
	public static GitHubContributorSoap[] toSoapModels(
		...
		GitHubContributorSoap[] soapModels = new GitHubContributorSoap[models.length];
	...
	public static GitHubContributorSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new GitHubContributorSoap[models.length][models[0].length];
		}
		else {
	...
	public static GitHubContributorSoap[] toSoapModels(
		...
		List<GitHubContributorSoap> soapModels = new ArrayList<GitHubContributorSoap>(models.size());
