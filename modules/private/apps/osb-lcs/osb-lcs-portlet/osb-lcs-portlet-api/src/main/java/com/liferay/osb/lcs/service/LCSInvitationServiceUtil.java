...
/**
 * Provides the remote service utility for LCSInvitation. This utility wraps
 * {@link com.liferay.osb.lcs.service.impl.LCSInvitationServiceImpl} and is the
 ...
 */
@ProviderType
public class LCSInvitationServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	private static ServiceTracker<LCSInvitationService, LCSInvitationService> _serviceTracker =
		ServiceTrackerFactory.open(LCSInvitationService.class);
}