...
/**
 * Provides the local service interface for LCSNotificationAuditEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Igor Beslic
 * @see LCSNotificationAuditEntryLocalServiceUtil
...
public interface LCSNotificationAuditEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LCSNotificationAuditEntryLocalServiceUtil} to access the l c s notification audit entry local service. Add custom service methods to {@link com.liferay.osb.lcs.service.impl.LCSNotificationAuditEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public LCSNotificationAuditEntry createLCSNotificationAuditEntry(
	...
	*/
	...
	public LCSNotificationAuditEntry deleteLCSNotificationAuditEntry(
		LCSNotificationAuditEntry lcsNotificationAuditEntry);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LCSNotificationAuditEntry deleteLCSNotificationAuditEntry(
		long lcsNotificationAuditEntryId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LCSNotificationAuditEntry fetchLCSNotificationAuditEntry(
		long lcsNotificationAuditEntryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LCSNotificationAuditEntry getLCSNotificationAuditEntry(
		long lcsNotificationAuditEntryId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LCSNotificationAuditEntry updateLCSNotificationAuditEntry(
		LCSNotificationAuditEntry lcsNotificationAuditEntry);
