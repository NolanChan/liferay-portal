...
/**
 * Provides the base implementation for the l c s message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.lcs.service.impl.LCSMessageLocalServiceImpl}.
 * </p>
 *
 * @author Igor Beslic
 ...
 */
@ProviderType
public abstract class LCSMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LCSMessageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.lcs.service.LCSMessageLocalServiceUtil} to access the l c s message local service.
	 */
	...
	public LCSMessage createLCSMessage(long lcsMessageId) {
		return lcsMessagePersistence.create(lcsMessageId);
	}
	...
	public LCSMessage deleteLCSMessage(long lcsMessageId)
		...
		return lcsMessagePersistence.remove(lcsMessageId);
	}
	...
	public LCSMessage deleteLCSMessage(LCSMessage lcsMessage) {
		return lcsMessagePersistence.remove(lcsMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LCSMessage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lcsMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return lcsMessagePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lcsMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public LCSMessage fetchLCSMessage(long lcsMessageId) {
		return lcsMessagePersistence.fetchByPrimaryKey(lcsMessageId);
	}
	...
	public LCSMessage getLCSMessage(long lcsMessageId)
		throws PortalException {
		return lcsMessagePersistence.findByPrimaryKey(lcsMessageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lcsMessageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LCSMessage.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lcsMessageId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(lcsMessageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LCSMessage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return lcsMessageLocalService.deleteLCSMessage((LCSMessage)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return lcsMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LCSMessage> getLCSMessages(int start, int end) {
		return lcsMessagePersistence.findAll(start, end);
	}
	...
	public int getLCSMessagesCount() {
		return lcsMessagePersistence.countAll();
	}
	 ...
	 */
	public LCSMessageLocalService getLCSMessageLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.osb.lcs.model.LCSMessage",
			lcsMessageLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.osb.lcs.model.LCSMessage");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LCSMessageLocalService.class.getName();
	}
	...
	@BeanReference(type = LCSMessageLocalService.class)
	protected LCSMessageLocalService lcsMessageLocalService;
