...
/**
 * Provides the base implementation for the user l c s message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.lcs.service.impl.UserLCSMessageLocalServiceImpl}.
 * </p>
 *
 * @author Igor Beslic
 ...
 */
@ProviderType
public abstract class UserLCSMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserLCSMessageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.lcs.service.UserLCSMessageLocalServiceUtil} to access the user l c s message local service.
	 */
	...
	public UserLCSMessage createUserLCSMessage(long userLcsMessageId) {
		return userLCSMessagePersistence.create(userLcsMessageId);
	}
	...
	public UserLCSMessage deleteUserLCSMessage(long userLcsMessageId)
		...
		return userLCSMessagePersistence.remove(userLcsMessageId);
	}
	...
	public UserLCSMessage deleteUserLCSMessage(UserLCSMessage userLCSMessage) {
		return userLCSMessagePersistence.remove(userLCSMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserLCSMessage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userLCSMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userLCSMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public UserLCSMessage fetchUserLCSMessage(long userLcsMessageId) {
		return userLCSMessagePersistence.fetchByPrimaryKey(userLcsMessageId);
	}
	...
	public UserLCSMessage getUserLCSMessage(long userLcsMessageId)
		throws PortalException {
		return userLCSMessagePersistence.findByPrimaryKey(userLcsMessageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userLCSMessageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserLCSMessage.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("userLcsMessageId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userLCSMessageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UserLCSMessage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userLCSMessageLocalService.deleteUserLCSMessage((UserLCSMessage)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userLCSMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserLCSMessage> getUserLCSMessages(int start, int end) {
		return userLCSMessagePersistence.findAll(start, end);
	}
	...
	public int getUserLCSMessagesCount() {
		return userLCSMessagePersistence.countAll();
	}
	 ...
	 */
	public UserLCSMessageLocalService getUserLCSMessageLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.osb.lcs.model.UserLCSMessage",
			userLCSMessageLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.osb.lcs.model.UserLCSMessage");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserLCSMessageLocalService.class.getName();
	}
	...
	@BeanReference(type = UserLCSMessageLocalService.class)
	protected UserLCSMessageLocalService userLCSMessageLocalService;
