...
/**
 * Provides the base implementation for the l c s patch entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.lcs.service.impl.LCSPatchEntryLocalServiceImpl}.
 * </p>
 *
 * @author Igor Beslic
 ...
 */
@ProviderType
public abstract class LCSPatchEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LCSPatchEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.lcs.service.LCSPatchEntryLocalServiceUtil} to access the l c s patch entry local service.
	 */
	...
	public LCSPatchEntry addLCSPatchEntry(LCSPatchEntry lcsPatchEntry) {
		...
		return lcsPatchEntryPersistence.update(lcsPatchEntry);
	}
	...
	public LCSPatchEntry createLCSPatchEntry(long lcsPatchEntryId) {
		return lcsPatchEntryPersistence.create(lcsPatchEntryId);
	}
	...
	public LCSPatchEntry deleteLCSPatchEntry(long lcsPatchEntryId)
		...
		return lcsPatchEntryPersistence.remove(lcsPatchEntryId);
	}
	...
	public LCSPatchEntry deleteLCSPatchEntry(LCSPatchEntry lcsPatchEntry) {
		return lcsPatchEntryPersistence.remove(lcsPatchEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LCSPatchEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lcsPatchEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lcsPatchEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public LCSPatchEntry fetchLCSPatchEntry(long lcsPatchEntryId) {
		return lcsPatchEntryPersistence.fetchByPrimaryKey(lcsPatchEntryId);
	}
	...
	public LCSPatchEntry getLCSPatchEntry(long lcsPatchEntryId)
		throws PortalException {
		return lcsPatchEntryPersistence.findByPrimaryKey(lcsPatchEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lcsPatchEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LCSPatchEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lcsPatchEntryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(lcsPatchEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LCSPatchEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return lcsPatchEntryLocalService.deleteLCSPatchEntry((LCSPatchEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return lcsPatchEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LCSPatchEntry> getLCSPatchEntries(int start, int end) {
		return lcsPatchEntryPersistence.findAll(start, end);
	}
	...
	public int getLCSPatchEntriesCount() {
		return lcsPatchEntryPersistence.countAll();
	}
	 ...
	 */
	public LCSPatchEntryLocalService getLCSPatchEntryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.osb.lcs.model.LCSPatchEntry",
			lcsPatchEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.osb.lcs.model.LCSPatchEntry");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LCSPatchEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = lcsPatchEntryPersistence.getDataSource();
	...
	@BeanReference(type = LCSPatchEntryLocalService.class)
	protected LCSPatchEntryLocalService lcsPatchEntryLocalService;
