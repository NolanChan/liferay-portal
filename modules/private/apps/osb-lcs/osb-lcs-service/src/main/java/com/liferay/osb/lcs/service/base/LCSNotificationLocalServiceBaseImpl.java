...
/**
 * Provides the base implementation for the l c s notification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.lcs.service.impl.LCSNotificationLocalServiceImpl}.
 * </p>
 *
 * @author Igor Beslic
 ...
 */
@ProviderType
public abstract class LCSNotificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LCSNotificationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.osb.lcs.service.LCSNotificationLocalServiceUtil} to access the l c s notification local service.
	 */
	...
	public LCSNotification createLCSNotification(long lcsNotificationId) {
		return lcsNotificationPersistence.create(lcsNotificationId);
	}
	...
	public LCSNotification deleteLCSNotification(long lcsNotificationId)
		...
		return lcsNotificationPersistence.remove(lcsNotificationId);
	}
	...
	public LCSNotification deleteLCSNotification(
		...
		return lcsNotificationPersistence.remove(lcsNotification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LCSNotification.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lcsNotificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lcsNotificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public LCSNotification fetchLCSNotification(long lcsNotificationId) {
		return lcsNotificationPersistence.fetchByPrimaryKey(lcsNotificationId);
	}
	...
	public LCSNotification getLCSNotification(long lcsNotificationId)
		throws PortalException {
		return lcsNotificationPersistence.findByPrimaryKey(lcsNotificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lcsNotificationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LCSNotification.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lcsNotificationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(lcsNotificationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LCSNotification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return lcsNotificationLocalService.deleteLCSNotification((LCSNotification)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return lcsNotificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LCSNotification> getLCSNotifications(int start, int end) {
		return lcsNotificationPersistence.findAll(start, end);
	}
	...
	public int getLCSNotificationsCount() {
		return lcsNotificationPersistence.countAll();
	}
	 ...
	 */
	public LCSNotificationLocalService getLCSNotificationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.osb.lcs.model.LCSNotification",
			lcsNotificationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.osb.lcs.model.LCSNotification");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LCSNotificationLocalService.class.getName();
	}
	...
	@BeanReference(type = LCSNotificationLocalService.class)
	protected LCSNotificationLocalService lcsNotificationLocalService;
