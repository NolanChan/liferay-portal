...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(OAuthUserClp.class.getName())) {
			return translateInputOAuthUser(oldModel);
		}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.oauth.model.impl.OAuthApplicationImpl")) {
		...
		if (oldModelClassName.equals(
					"com.liferay.oauth.model.impl.OAuthUserImpl")) {
			return translateOutputOAuthUser(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.liferay.oauth.exception.OAuthApplicationCallbackURIException")) {
			return new com.liferay.oauth.exception.OAuthApplicationCallbackURIException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.oauth.exception.OAuthApplicationNameException")) {
			return new com.liferay.oauth.exception.OAuthApplicationNameException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.oauth.exception.OAuthApplicationWebsiteURLException")) {
			return new com.liferay.oauth.exception.OAuthApplicationWebsiteURLException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.oauth.exception.NoSuchApplicationException")) {
			return new com.liferay.oauth.exception.NoSuchApplicationException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals("com.liferay.oauth.exception.NoSuchUserException")) {
			return new com.liferay.oauth.exception.NoSuchUserException(throwable.getMessage(),
				throwable.getCause());
		}
