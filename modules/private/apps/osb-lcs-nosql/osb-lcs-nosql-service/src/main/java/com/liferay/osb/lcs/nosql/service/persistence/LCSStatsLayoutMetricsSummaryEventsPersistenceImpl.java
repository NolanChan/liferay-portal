 ...
 */
public class LCSStatsLayoutMetricsSummaryEventsPersistenceImpl
	extends BaseLCSStatsPersistenceImpl<LCSStatsLayoutMetricsEvents>
	implements LCSStatsLayoutMetricsSummaryEventsPersistence {
	...
	@Override
	public List<LCSStatsLayoutMetricsEvents> fetchByC_E_G_K(
